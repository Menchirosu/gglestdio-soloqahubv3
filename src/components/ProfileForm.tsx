    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="flex flex-col items-center space-y-6">
        <div className="relative group">
          <div className="w-32 h-32 rounded-[24px] bg-secondary/20 overflow-hidden border-4 border-primary/20 shadow-xl transition-transform group-hover:scale-105">
            {selectedPhotoURL ? (
              <img 
        ...
        <div className="flex flex-col items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 bg-secondary/20 text-foreground font-bold rounded-full hover:bg-secondary/30 transition-all group"
          >
          ...
          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest">Or upload your own image</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full bg-secondary/20 border-none rounded-[16px] py-4 px-6 text-foreground focus:ring-2 focus:ring-primary/20 transition-all"
          maxLength={50}
          required
        />
      </div>
      ...
      <div className="flex gap-3 pt-4">
        <button
          type="button"
          onClick={onClose}
          className="flex-1 py-4 bg-secondary/20 text-foreground font-bold rounded-[16px] hover:bg-secondary/30 transition-all"
        >
          Cancel
        </button>
        <button
          ...
          className="flex-1 py-4 bg-primary text-white font-bold rounded-[16px] shadow-lg shadow-primary/20 hover:opacity-90 disabled:opacity-50 disabled:shadow-none transition-all"
        >
